...
class WebFormService extends Service{
     ...
     */
    public static function getMap(App $app = null){
     ...
     *
     * @param int $webFormId The ID from WebFormService::getMap.
     * @param App $app
     * @return string Full HTML for the web form.
     */
    public static function getHTML($webFormId, App $app = null)
    {
        $app = parent::getObjectOrDefaultAppIfNull($app);
     ...
     */
    public static function getJavaScript($webFormId, App $app = null)
    {
        $app = parent::getObjectOrDefaultAppIfNull($app);
        ...
        // Get the HTML
        $html = WebFormService::getHTML($webFormId, $app);
     ...
     */
    public static function getHostedURL($webFormId, App $app = null)
    {
        $app = parent::getObjectOrDefaultAppIfNull($app);
