...
class SavedSearchDataService extends Service {
    public static function queryWithOrderBy($object, $queryData, $orderByField = null, $ascending = true, $limit = 1000, $page = 0, $returnFields = false, App $app = null){
        $results = array();
        ...
        $rows = SearchService::getSavedSearchResultsAllFields($savedSearchId, $userId, $page);
