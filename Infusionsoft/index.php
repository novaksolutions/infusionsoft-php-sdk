...
<body>
<h1>Installation</h1>
<p>Copy the config.sample.php file to config.php and set your APIKey and App Hostname, this needs to be your complete app hostname, i.e.  joey.infusionsoft.com</p>
...
<li>
	<a href="admin/generate_classes_from_API_Field_access_file.php">Generate DataServiceObjects from API_Field_Access.xml</a></li>
</ul>
</body>
</html>